...
export const Case = () => (
  <Container>
    <Breadcrumb className="breadcrumb">
      ...
      <Breadcrumb.Item active>Ärende </Breadcrumb.Item>
    </Breadcrumb>
    <div className="grid-container-economy">
      <Card className="cardseco">
        <Card.Header>
          <Card.Title>Anställning</Card.Title>
        </Card.Header>
        <Card.Body>
          <Card.Text>
      ...
      <Card className="cardseco">
        <Card.Header>
          <Card.Title>Ombokning av kostnader</Card.Title>
        </Card.Header>
        <Card.Body>
          <Card.Text>
      ...
      <Card className="cardseco">
        <Card.Header>
          <Card.Title>Kassautbetalningar</Card.Title>
        </Card.Header>
        <Card.Body>
          <Card.Text>
            Short ribs porchetta buffalo pastrami strip steak prosciutto filet
    ...
    <div className="grid-container-economy">
      <Card className="cardseco">
        <Card.Header>
          <Card.Title>Avikelser</Card.Title>
        </Card.Header>
        <Card.Body>
          <Card.Text>
